...
class LoaderApp {
    constructor() {
        this.version = '0.1.7';
        console.log(`%c 🚀 Open WebUI Prompt Plus v${this.version} %c https://github.com/Fu-Jie/open-webui-prompt-plus `, 'background: #667eea; color: #fff; border-radius: 3px 0 0 3px; padding: 2px 5px; font-weight: bold;', 'background: #764ba2; color: #fff; border-radius: 0 3px 3px 0; padding: 2px 5px;');
