...
export class ManagementPanel {
        ...
        const handleAction = (e) => {
            ...
            switch (action) {
                ...
                case 'updatePromptCategory':
                    // NOOP: Category changes are handled directly by PromptItem's onchange handler.
                    // Keeping this case only to prevent the 'Unknown action' warning.
                    break;
    ...
    async updatePromptCategory(promptId, categoryId) {
        ...
        try {
            ...
            // Refresh list to ensure UI references (IDs) are updated and avoid stale references
            this.updatePromptList();
            this.updateCategoryList();
